...
// KeyUsage - использования ключа. Может быть установлен в следующие значения::
...
const (
	...
	KeyUsageSign    KeyUsage = "SIGN" // Ключ предназначен непосредственно для подписи документов
