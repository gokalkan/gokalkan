...
const (
	...
	ErrorCodeTSACreateQuery               KCErrorCode = 149946436 // 0x08F00044	Ошибка генерации запроса timestamp
	ErrorCodeCreateObj                    KCErrorCode = 149946437 // 	0x08F00045	Ошибка записи OID в ASN1 структуру
	ErrorCodeCreateNoNce                  KCErrorCode = 149946438 // 	0x08F00046	Ошибка генерации уникального числа
	ErrorCodeHTTPError                    KCErrorCode = 149946439 // 	0x08F00047	Ошибка протокола http
	ErrorCodeCADESBESFailed               KCErrorCode = 149946440 // 	0x08F00048	Ошибка проверки расширения CADESBES в CMS
	ErrorCodeCADESTFailed                 KCErrorCode = 149946441 // 	0x08F00049	Ошибка проверки подписи токена TSA
	ErrorCodeNoTSAToken                   KCErrorCode = 149946442 // 	0x08F0004a	В подписи не присутствует метка TSA
	ErrorCodeInvalidDigestLen             KCErrorCode = 149946443 // 	0x08F0004b	Неправильная длина хэша
	ErrorCodeGenRandError                 KCErrorCode = 149946444 // 	0x08F0004c	Ошибка генерации случайного числа
	ErrorCodeSoapNSError                  KCErrorCode = 149946445 // 	0x08F0004d	Не найдены заголовки SOAP-сообщений
	ErrorCodeGetPubKey                    KCErrorCode = 149946446 // 	0x08F0004e	Ошибка экспорта публичного ключа
	ErrorCodeGetCertInfo                  KCErrorCode = 149946447 // 	0x08F0004f	Ошибка получения информации о сертификате
	ErrorCodeFileReadError                KCErrorCode = 149946448 // 	0x08F00050	Ошибка чтения файла
	ErrorCodeCheckError                   KCErrorCode = 149946449 // 	0x08F00051	Хэш не совпадает
	ErrorCodeZipExtractErr                KCErrorCode = 149946450 // 	0x08F00052	Невозможно открыть архив
	ErrorCodeNoManifestFile               KCErrorCode = 149946451 // 	0x08F00053	Не найден MANIFEST
	ErrorCodeVerifyTSHash                 KCErrorCode = 149946452 // 	0x08F00054	не удалось проверить Хэш подписи TS
	ErrorCodeXADESTFailed                 KCErrorCode = 149946453 // 	0x08F00055	XAdES-T: Ошибка проверки подписи
	ErrorCodeOCSPRespStatMalformedRequest KCErrorCode = 149946454 // 	0x08F00056	Неправильный запрос
	ErrorCodeOCSPRespStatInternalError    KCErrorCode = 149946455 // 	0x08F00057	Внутренняя ошибка
	ErrorCodeOCSPRespStatTryLater         KCErrorCode = 149946456 // 	0x08F00058	Попробуйте позже
	ErrorCodeOCSPRespStatSigRequired      KCErrorCode = 149946457 // 	0x08F00059	Должны подписать запрос
	ErrorCodeOCSPRespStatUnauthorized     KCErrorCode = 149946458 // 	0x08F0005a	Запрос не авторизован
	ErrorCodeVerifyIssuerSerialV2         KCErrorCode = 149946459 // 	0x08F0005b	не удалось проверить IssuerSerialV2 в XAdES
	ErrorCodeOCSPCheckCertFromResp        KCErrorCode = 149946460 // 	0x08F0005c	Ошибка проверки сертификата OCSP-респондера
	ErrorCodeCRLExpired                   KCErrorCode = 149946461 // 	0x08F0005d	CRL-файл просрочен
