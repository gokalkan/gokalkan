...
var CertPropMap = map[string]CertProp{
	"CertPropIssuerCountryName":   CertPropIssuerCountryName,
	"CertPropIssuerSOPN":          CertPropIssuerSOPN,
	"CertPropIssuerLocalityName":  CertPropIssuerLocalityName,
	"CertPropIssuerOrgName":       CertPropIssuerOrgName,
	"CertPropIssuerOrgUnitName":   CertPropIssuerOrgUnitName,
	"CertPropIssuerCommonName":    CertPropIssuerCommonName,
	"CertPropSubjectCountryName":  CertPropSubjectCountryName,
	"CertPropSubjectSOPN":         CertPropSubjectSOPN,
	"CertPropSubjectLocalityName": CertPropSubjectLocalityName,
	"CertPropSubjectCommonName":   CertPropSubjectCommonName,
	"CertPropSubjectGivenName":    CertPropSubjectGivenName,
	"CertPropSubjectSurname":      CertPropSubjectSurname,
	"CertPropSubjectSerialNumber": CertPropSubjectSerialNumber,
	"CertPropSubjectEmail":        CertPropSubjectEmail,
	"CertPropSubjectOrgName":      CertPropSubjectOrgName,
	"CertPropSubjectOrgUnitName":  CertPropSubjectOrgUnitName,
	"CertPropSubjectBc":           CertPropSubjectBc,
	"CertPropSubjectDc":           CertPropSubjectDc,
	"CertPropNotBefore":           CertPropNotBefore,
	"CertPropNotAfter":            CertPropNotAfter,
	"CertPropKeyUsage":            CertPropKeyUsage,
	"CertPropExtKeyUsage":         CertPropExtKeyUsage,
	"CertPropAuthKeyID":           CertPropAuthKeyID,
	"CertPropSubjKeyID":           CertPropSubjKeyID,
	"CertPropCertCN":              CertPropCertCN,
	"CertPropIssuerDN":            CertPropIssuerDN,
	"CertPropSubjectDN":           CertPropSubjectDN,
	"CertPropSignatureAlg":        CertPropSignatureAlg,
	"CertPropPubKey":              CertPropPubKey,
	"CertPropPoliciesID":          CertPropPoliciesID,
	"CertPropOCSP":                CertPropOCSP,
	"CertPropGetCRL":              CertPropGetCRL,
	"CertPropGetDeltaCRL":         CertPropGetDeltaCRL,
}